...
cppjinja::east::string_t cppjinja::evtnodes::block_call::evaluate(cppjinja::evt::exenv& env) const
{

}

std::vector<cppjinja::east::function_parameter> cppjinja::evtnodes::block_call::solved_params(cppjinja::evt::exenv& env) const
{
