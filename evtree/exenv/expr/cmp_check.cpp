...
cppjinja::evt::expr_evals::cmp_check::cmp_check(cppjinja::ast::expr_ops::cmp_op op)
    : op_(op)
{
}
...
cppjinja::ast::expr_ops::term cppjinja::evt::expr_evals::cmp_check::operator()(const ast::string_t&, const bool&) const
{throw_int_and_string_op();}
cppjinja::ast::expr_ops::term cppjinja::evt::expr_evals::cmp_check::operator()(const ast::string_t&, const std::int64_t&) const
{throw_int_and_string_op();}
