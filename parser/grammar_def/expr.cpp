...
BOOST_SPIRIT_INSTANTIATE( decltype(logic_check),iterator_type, context_type )
BOOST_SPIRIT_INSTANTIATE( decltype(negate),     iterator_type, context_type )
BOOST_SPIRIT_INSTANTIATE( decltype(fnc_call),   iterator_type, context_type )
BOOST_SPIRIT_INSTANTIATE( decltype(filter),     iterator_type, context_type )
BOOST_SPIRIT_INSTANTIATE( decltype(op_if),      iterator_type, context_type )
