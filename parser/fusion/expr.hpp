...
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::cmp_check, op, left, right)
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::log_in_check, op, left, right)
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::negate, arg)
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::fnc_call, ref, pos_args, named_args)
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::filter, ref, pos_args, named_args)
BOOST_FUSION_ADAPT_STRUCT(cppjinja::ast::expr_ops::filtered_val, val, filters)
